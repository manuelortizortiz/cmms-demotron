...
def dashboard():
    try:
        ...
        # 1. EXTRACCIÓN DE TODA LA BASE DE DATOS
        ...
        # ==========================================
        # CINTA 2: COMPRAS, ESTADO Y GASTOS (FEBRERO A HOY)
        # ==========================================
        ...
        # ==========================================
        # CINTA 3: MTBF Y MTTR POR MARCA
        # ==========================================
        marcas_stats = {}
        for e in eqs_db:
            m = e.marca or 'Sin Marca'
            if m not in marcas_stats:
                marcas_stats[m] = {'count': 0, 'fallas': 0, 'horas_rep': 0}
        ...
        # ==========================================
        # CINTA 4: TABLAS DE GESTIÓN (TOP 5)
        # ==========================================
        ...
        # Inyectar última fecha de OT a equipos en taller
        taller_list = []
        ...
        # ==========================================
        # DATA LISTAS (Equipos, CPK, Geolocalización, Calendario)
        # ==========================================
        equipos_list = []
        finanzas_flota = []
        eventos_calendario = []
        ...
        return render_template('index.html', 
            ...
            kanban=kanban, eventos_calendario=eventos_calendario
        )
...
def imprimir_ot(ot_id):
    try:
        ...
        if not ot: 
            return "Aviso: El documento PDF no existe o la Orden de Trabajo fue eliminada del sistema."
